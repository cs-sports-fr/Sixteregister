...
_Participant_isBoursier_OrderByInput = TypedDict(
    '_Participant_isBoursier_OrderByInput',
    {
        'isBoursier': 'SortOrder',
    },
    total=True
)
...
class ParticipantWhereInput(TypedDict, total=False):
    ...
    isBoursier: Union[_bool, 'types.BooleanFilter']
...
class ParticipantScalarWhereWithAggregatesInput(TypedDict, total=False):
    ...
    isBoursier: Union[_bool, 'types.BooleanWithAggregatesFilter']
