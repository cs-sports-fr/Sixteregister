...
SCHEMA_PATH = Path('/Users/erwinaudit/Sixte/sixte-s8/Sixteregister/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin': '/Users/erwinaudit/.cache/prisma-python/binaries/5.11.0/efd2449663b3d73d637ea1fd226bafbcf45b3102/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    sport: 'actions.SportActions[models.Sport]'
    team: 'actions.TeamActions[models.Team]'
    user: 'actions.UserActions[models.User]'
    participant: 'actions.ParticipantActions[models.Participant]'
    school: 'actions.SchoolActions[models.School]'
    generalconfig: 'actions.GeneralConfigActions[models.GeneralConfig]'
    ...
    def __init__(
        ...
        *,
        ...
        self.sport = actions.SportActions[models.Sport](self, models.Sport)
        self.team = actions.TeamActions[models.Team](self, models.Team)
        self.user = actions.UserActions[models.User](self, models.User)
        self.participant = actions.ParticipantActions[models.Participant](self, models.Participant)
        self.school = actions.SchoolActions[models.School](self, models.School)
        self.generalconfig = actions.GeneralConfigActions[models.GeneralConfig](self, models.GeneralConfig)
...
class Batch:
    sport: 'SportBatchActions'
    team: 'TeamBatchActions'
    user: 'UserBatchActions'
    participant: 'ParticipantBatchActions'
    school: 'SchoolBatchActions'
    generalconfig: 'GeneralConfigBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.sport = SportBatchActions(self)
        self.team = TeamBatchActions(self)
        self.user = UserBatchActions(self)
        self.participant = ParticipantBatchActions(self)
        self.school = SchoolBatchActions(self)
        self.generalconfig = GeneralConfigBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class GeneralConfigBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
